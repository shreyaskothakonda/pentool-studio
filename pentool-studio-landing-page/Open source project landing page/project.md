# Pentool — project brief

Source material for a landing page. Everything here is true of the built system,
not aspirational; the limits section is as load-bearing as the features.
...
| Design system | Client-First v2.1 / Relume v3.0, configurable |
...
| Tests | 217 across both projects |
